...
var author$project$Components$ModulesPage$view = _List_fromArray(
	[
		A2(
		elm$html$Html$h1,
		_List_Nil,
...
var author$project$Main$pageModules = author$project$Components$ModulesPage$view;
	...
	return A2(
		...
		function () {
			...
			switch (_n0.$) {
				...
				case 'Modules':
					return author$project$Main$pageModules;
				default:
